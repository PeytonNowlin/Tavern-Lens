...
///
/// Injected into the engine. The tribe resolver (hero-pick banner reading plus inference,
/// ticket #13) is meant to provide it; until then `SeenPoolMinionTribes` stands in.
